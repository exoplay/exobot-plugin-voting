Contributing to exobot-plugin-voting
======================

So you want to contribute to exobot-plugin-voting? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-plugin-voting/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-plugin-voting/fork_select) to
  your Github account.
...
exobot-plugin-voting is MIT licensed. See details in the LICENSE file. This is a very permissive
